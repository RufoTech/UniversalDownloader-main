...
export async function GET(req: NextRequest) {
  ...
  try {
    ...
    // YouTube: Skip yt-dlp entirely (blocked on cloud IPs), return predefined quality options
    // The actual download will go through Cobalt API in the download route
